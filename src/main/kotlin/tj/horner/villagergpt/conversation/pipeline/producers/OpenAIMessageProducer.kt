...
class OpenAIMessageProducer(config: Configuration) : ConversationMessageProducer {
    ...
    private val openAIModel = config.getString("openai-model")?: "cognitivecomputations/dolphin-2.6-mixtral-8x7b"
    private val openAIUrl = config.getString("openai-url")?: "https://api.deepinfra.com/openai"
